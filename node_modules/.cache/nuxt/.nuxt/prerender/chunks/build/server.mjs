import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, getCurrentInstance, unref, mergeProps, withCtx, renderSlot, shallowRef, provide, cloneVNode, h, createElementBlock, hasInjectionContext, inject, computed, useSSRContext, ref, Suspense, Fragment, createApp, createVNode, Text, createBlock, openBlock, toDisplayString as toDisplayString$1, shallowReactive, watch, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, getCurrentScope } from 'file:///media/ibrahim/D/my-portfolio/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///media/ibrahim/D/my-portfolio/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///media/ibrahim/D/my-portfolio/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, getRequestURL, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie } from 'file:///media/ibrahim/D/my-portfolio/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///media/ibrahim/D/my-portfolio/node_modules/vue-router/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///media/ibrahim/D/my-portfolio/node_modules/radix3/dist/index.mjs';
import { createDefu, defu } from 'file:///media/ibrahim/D/my-portfolio/node_modules/defu/dist/defu.mjs';
...
import { parse as parse$1 } from 'file:///media/ibrahim/D/my-portfolio/node_modules/cookie-es/dist/index.mjs';
import destr from 'file:///media/ibrahim/D/my-portfolio/node_modules/destr/dist/index.mjs';
import { isEqual } from 'file:///media/ibrahim/D/my-portfolio/node_modules/ohash/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file:///media/ibrahim/D/my-portfolio/node_modules/vue-devtools-stub/dist/index.mjs';
import { useColorMode, provideSSRWidth } from 'file:///media/ibrahim/D/my-portfolio/node_modules/@vueuse/core/index.mjs';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderStyle, ssrRenderSuspense, ssrRenderVNode } from 'file:///media/ibrahim/D/my-portfolio/node_modules/vue/server-renderer/index.mjs';
import { Sun, Moon, Languages, Menu, X, Heart, Code2 } from 'file:///media/ibrahim/D/my-portfolio/node_modules/lucide-vue-next/dist/cjs/lucide-vue-next.js';
import { cva } from 'file:///media/ibrahim/D/my-portfolio/node_modules/class-variance-authority/dist/index.mjs';
import { Primitive } from 'file:///media/ibrahim/D/my-portfolio/node_modules/reka-ui/dist/index.js';
import { clsx } from 'file:///media/ibrahim/D/my-portfolio/node_modules/clsx/dist/clsx.mjs';
import { twMerge } from 'file:///media/ibrahim/D/my-portfolio/node_modules/tailwind-merge/dist/bundle-mjs.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CIw7iFDH.mjs')
  }
];
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`/_i18n/${"PsXMelXj"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `/_i18n/${"PsXMelXj"}/${locale}/messages.json`));
...
const nav$1 = { "home": "Home", "about": "About", "skills": "Skills", "projects": "Projects", "contact": "Contact" };
const hero$1 = { "greeting": "Hi, I'm", "title": "Front-End Web Developer", "subtitle": "I build modern, responsive, and user-friendly web applications", "cta": "View My Work", "contact": "Get In Touch" };
const about$1 = { "title": "About Me", "description": "Passionate Front-End Developer with 2+ years of experience building modern, responsive, and user-friendly web applications. Specialized in Vue.js, Nuxt.js, and Tailwind CSS, with strong knowledge in performance optimization, accessibility, and SEO. Basic experience with NestJS and Mongoose enables me to contribute to full-stack applications. Skilled at collaborating with cross-functional teams and delivering high-quality projects. Currently seeking opportunities to contribute to innovative products and grow within the web development industry.", "experience": "Years Experience", "projects": "Projects Completed", "clients": "Happy Clients", "workExperience": "Work Experience", "genwin": "Front-End Web Developer at Genwin (2024 - April)", "genwinDesc": "Designed and developed responsive web applications using Vue.js, Nuxt.js, JavaScript, and Tailwind CSS. Implemented UI/UX designs to improve user experience and reduce bounce rates by 30%. Collaborated with back-end developers and designers to ensure smooth integration of APIs and features.", "freelance": "Freelance Projects (2025 - June)", "freelanceDesc": "Built complete e-commerce platforms, user management dashboards, and custom web applications. Focused on performance, user experience, and mobile-first design with full SEO optimization and accessibility best practices." };
const skills$1 = { "title": "My Skills", "subtitle": "Technologies I work with", "frontend": "Frontend", "backend": "Backend", "tools": "Tools & Others" };
const projects$1 = { "title": "Featured Projects", "subtitle": "Some of my recent work", "viewProject": "View Project", "viewCode": "View Code" };
const contact$1 = { "title": "Get In Touch", "subtitle": "Let's work together", "name": "Name", "email": "Email", "message": "Message", "send": "Send Message", "sending": "Sending...", "success": "Message sent successfully!", "error": "Failed to send message. Please try again." };
const footer$1 = { "rights": "All rights reserved", "built": "Built with" };
const theme$1 = { "light": "Light", "dark": "Dark", "system": "System" };
const testimonials$1 = { "title": "Client Testimonials", "subtitle": "What people say about my work" };
const en = {
  nav: nav$1,
  hero: hero$1,
  about: about$1,
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const toggleLanguage = () => {
      ...
      (void 0).documentElement.dir = newLocale === "ar" ? "rtl" : "ltr";
    };
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-sm" }, _attrs))} data-v-52388acc><div class="container flex h-16 items-center justify-between px-4" data-v-52388acc><div class="flex items-center gap-2" data-v-52388acc><div class="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-primary to-purple-600" data-v-52388acc><span class="text-white font-bold text-lg" data-v-52388acc>${ssrInterpolate(unref(locale) === "ar" ? "م" : "P")}</span></div><span class="text-xl font-bold bg-gradient-to-r from-primary via-purple-600 to-pink-600 bg-clip-text text-transparent" data-v-52388acc>${ssrInterpolate(unref(locale) === "ar" ? "محفظتي" : "Portfolio")}</span></div><nav class="hidden md:flex items-center gap-1" data-v-52388acc><!--[-->`);
      ssrRenderList(navItems, (item) => {
        _push(`<a${ssrRenderAttr("href", `#${item}`)} class="px-4 py-2 text-sm font-medium text-muted-foreground transition-all duration-200 hover:text-foreground hover:bg-accent rounded-md relative group" data-v-52388acc>${ssrInterpolate(item.charAt(0).toUpperCase() + item.slice(1))} <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full" data-v-52388acc></span></a>`);
      });
      _push(`<!--]--></nav><div class="flex items-center gap-2" data-v-52388acc>`);
      _push(ssrRenderComponent(unref(_sfc_main$9), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (isDark.value) {
              _push2(ssrRenderComponent(unref(Sun), { class: "h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all" }, null, _parent2, _scopeId));
            } else {
              _push2(ssrRenderComponent(unref(Moon), { class: "h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all" }, null, _parent2, _scopeId));
            }
          } else {
            return [
      ...
      _push(ssrRenderComponent(unref(_sfc_main$9), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Languages), { class: "h-4 w-4" }, null, _parent2, _scopeId));
            _push2(`<span class="text-xs font-semibold" data-v-52388acc${_scopeId}>${ssrInterpolate(currentLang.value)}</span>`);
          } else {
            return [
              createVNode(unref(Languages), { class: "h-4 w-4" }),
              createVNode("span", { class: "text-xs font-semibold" }, toDisplayString$1(currentLang.value), 1)
            ];
          }
        }),
        _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!mobileMenuOpen.value) {
              _push2(ssrRenderComponent(unref(Menu), { class: "h-5 w-5" }, null, _parent2, _scopeId));
            } else {
      ...
      _push(`</div></div>`);
      if (mobileMenuOpen.value) {
        _push(`<div class="md:hidden border-t border-border/40 bg-background/95 backdrop-blur" data-v-52388acc><div class="container py-4 flex flex-col gap-2 px-4" data-v-52388acc><!--[-->`);
        ssrRenderList(navItems, (item) => {
          _push(`<a${ssrRenderAttr("href", `#${item}`)} class="px-4 py-3 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent rounded-md transition-all" data-v-52388acc>${ssrInterpolate(item.charAt(0).toUpperCase() + item.slice(1))}</a>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$8, [["__scopeId", "data-v-52388acc"]]), { __name: "Navigation" });
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "py-8 border-t bg-background" }, _attrs))}><div class="container mx-auto px-4"><div class="flex flex-col md:flex-row items-center justify-between gap-4"><p class="text-sm text-muted-foreground"> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Ibrahim Ghaybour. ${ssrInterpolate(unref(t)("footer.rights"))}. </p><p class="text-sm text-muted-foreground flex items-center gap-2">${ssrInterpolate(unref(t)("footer.built"))} `);
      _push(ssrRenderComponent(unref(Heart), { class: "w-4 h-4 text-red-500 fill-red-500 animate-pulse" }, null, _parent));
      _push(` ${ssrInterpolate(unref(locale) === "ar" ? "و" : "and")} `);
      _push(ssrRenderComponent(unref(Code2), { class: "w-4 h-4 text-primary" }, null, _parent));
...
const __nuxt_component_2 = Object.assign(_sfc_main$7, { __name: "Footer" });
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (isVisible.value) {
        ...
        }, _attrs))} data-v-3ef2fa1d><svg class="w-6 h-6 transform group-hover:-translate-y-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3ef2fa1d><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" data-v-3ef2fa1d></path></svg><span class="absolute inset-0 rounded-full bg-primary opacity-0 group-hover:opacity-20 group-hover:scale-150 transition-all duration-500" data-v-3ef2fa1d></span></button>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["__scopeId", "data-v-3ef2fa1d"]]), { __name: "BackToTop" });
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  __name: "Floating3DObjects",
  __ssrInlineRender: true,
  setup(__props) {
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Floating3DObjects.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const Floating3DObjects = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["__scopeId", "data-v-e473432e"]]), { __name: "Floating3DObjects" });
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (isLoading.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed inset-0 z-[9999] bg-background flex items-center justify-center overflow-hidden" }, _attrs))} data-v-005927b6><div class="absolute inset-0 bg-gradient-to-br from-primary/10 via-purple-500/10 to-blue-500/10 animate-gradient" data-v-005927b6></div><div class="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto w-full" data-v-005927b6><div class="mb-6 sm:mb-8" data-v-005927b6><h1 class="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-3 sm:mb-4 leading-tight break-words" data-v-005927b6><!--[-->`);
        ssrRenderList(unref(nameLetters), (letter, index) => {
          _push(`<span class="inline-block animate-letter bg-gradient-to-r from-primary via-purple-600 to-blue-600 bg-clip-text text-transparent" style="${ssrRenderStyle({ animationDelay: `${index * 0.1}s` })}" data-v-005927b6>${ssrInterpolate(letter === " " ? " " : letter)}</span>`);
        });
        _push(`<!--]--></h1><p class="text-base sm:text-lg md:text-xl text-muted-foreground animate-fade-in-up px-4" style="${ssrRenderStyle({ "animation-delay": "1.5s" })}" data-v-005927b6>${ssrInterpolate(unref(locale) === "ar" ? "مطور واجهات أمامية" : "Frontend Developer")}</p></div><div class="max-w-xs sm:max-w-md mx-auto px-4" data-v-005927b6><div class="relative h-1 bg-muted rounded-full overflow-hidden mb-4" data-v-005927b6><div class="absolute inset-y-0 left-0 bg-gradient-to-r from-primary via-purple-600 to-blue-600 rounded-full transition-all duration-300 ease-out" style="${ssrRenderStyle({ width: `${progress.value}%` })}" data-v-005927b6><div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent animate-shimmer" data-v-005927b6></div></div></div><p class="text-sm text-muted-foreground animate-pulse" data-v-005927b6>${ssrInterpolate(unref(locale) === "ar" ? "جاري التحميل..." : "Loading...")} ${ssrInterpolate(Math.round(progress.value))}% </p></div><div class="flex justify-center gap-2 mt-8" data-v-005927b6><!--[-->`);
        ssrRenderList(3, (i) => {
          _push(`<div class="w-2 h-2 bg-primary rounded-full animate-bounce" style="${ssrRenderStyle({ animationDelay: `${i * 0.15}s` })}" data-v-005927b6></div>`);
        });
        _push(`<!--]--></div></div><div class="hidden md:block absolute top-10 left-10 w-16 h-16 lg:w-20 lg:h-20 border-2 border-primary/20 rounded-full animate-spin-slow" data-v-005927b6></div><div class="hidden md:block absolute bottom-10 right-10 w-24 h-24 lg:w-32 lg:h-32 border-2 border-purple-500/20 rounded-full animate-spin-slow" style="${ssrRenderStyle({ "animation-direction": "reverse" })}" data-v-005927b6></div><div class="hidden lg:block absolute top-1/2 right-20 w-16 h-16 border-2 border-blue-500/20 rounded-full animate-pulse" data-v-005927b6></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const LoadingScreen = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-005927b6"]]), { __name: "LoadingScreen" });
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed top-0 left-0 right-0 z-[100] h-1 bg-muted/30" }, _attrs))}><div class="h-full bg-gradient-to-r from-primary via-purple-600 to-blue-600 transition-all duration-150 ease-out" style="${ssrRenderStyle({ width: `${scrollProgress.value}%` })}"><div class="absolute inset-0 bg-gradient-to-r from-primary via-purple-600 to-blue-600 blur-sm opacity-50"></div></div></div>`);
    };
  }
});
...
const ScrollProgress = Object.assign(_sfc_main$3, { __name: "ScrollProgress" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    watch(locale, (newLocale) => {
      (void 0).documentElement.dir = newLocale === "ar" ? "rtl" : "ltr";
      (void 0).documentElement.lang = newLocale;
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Navigation = __nuxt_component_0;
      const _component_NuxtPage = __nuxt_component_1;
      const _component_Footer = __nuxt_component_2;
      const _component_BackToTop = __nuxt_component_3;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(LoadingScreen, null, null, _parent));
      _push(ssrRenderComponent(ScrollProgress, null, null, _parent));
      _push(ssrRenderComponent(Floating3DObjects, null, null, _parent));
      _push(ssrRenderComponent(_component_Navigation, { class: "z-50" }, null, _parent));
      _push(`<main class="min-h-screen w-full relative z-20">`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-MQ6nV90e.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C3qZUWnM.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, withoutTrailingSlash as c, nuxtLinkDefaults as d, entry$1 as default, useHead as e, useI18n as f, _sfc_main$9 as g, hasProtocol as h, cn as i, joinURL as j, __nuxt_component_0$1 as k, navigateTo as n, parseQuery as p, resolveRouteObject as r, useRouter as u, withTrailingSlash as w };
